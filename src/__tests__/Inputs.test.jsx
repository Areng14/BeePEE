...
const mockFgdData = {
    ...
    'trigger_once': {
        ...
        outputs: [
            { name: 'OnTrigger', needsParam: false }
        ]
    }
}
...
describe('Inputs Component', () => {
    ...
    describe('Duplicate Entity Detection', () => {
        test('should detect and mark duplicate entity names with bold text and icon', async () => {
            ...
            await waitFor(() => {
                ...
                const groupIcons = document.querySelectorAll('[data-testid="GroupWorkIcon"]')
        ...
        test('should not mark single entities as duplicates', async () => {
            ...
            await waitFor(() => {
                ...
                expect(doorOption.closest('li')).not.toContain('[data-testid="GroupWorkIcon"]')
            })
        })
    })
    ...
    describe('Output Validation', () => {
        test('should validate output configuration correctly', async () => {
            ...
            await waitFor(() => {
                ...
                fireEvent.change(outputSelect, { target: { value: 'OnPressed' } })
            })
    ...
    describe('Dual Input Validation', () => {
        test('should validate dual input configuration', async () => {
            ...
            fireEvent.change(enableEntitySelect, { target: { value: 'button_1' } })

            await waitFor(() => {
                const enableInputSelect = screen.getByLabelText('Enable Input')
                fireEvent.change(enableInputSelect, { target: { value: 'Press' } })
            })
            ...
            fireEvent.change(disableEntitySelect, { target: { value: 'button_2' } })

            await waitFor(() => {
                const disableInputSelect = screen.getByLabelText('Disable Input')
                fireEvent.change(disableInputSelect, { target: { value: 'Press' } })
            })
    ...
    describe('Validation Error Messages', () => {
        test('should show specific error message in tooltip when hovering disabled button', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('Please select an enable entity')).toBeInTheDocument()
            })
        })
        ...
        test('should show parameter required message', async () => {
            ...
            await waitFor(() => {
                expect(screen.getByText('This input requires a parameter')).toBeInTheDocument()
            })
        })
    })
